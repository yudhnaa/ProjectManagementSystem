    ...
    public partial class CtrlPanelProjectAdmin : UserControl
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (selectedStatus == -1)
                {
                    // Nếu chọn "Tất cả", gọi GetAllProjectsIncludeDeleteCancel
                    projects = projectServices.GetAllProjectsInlcudeInActive("");
                }
                else
                {
        ...
        {
            FormProjectCreate formCreateProject = new FormProjectCreate();
