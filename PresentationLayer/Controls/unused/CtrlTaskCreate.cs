...
{
    public partial class CtrlTaskCreate : UserControl
    {
        public UserDTO user;
        ...
        public CtrlTaskCreate(TaskDTO parentTask, ProjectDTO project)
        {
        ...
        public CtrlTaskCreate(ProjectDTO project)
        {
            this.user = UserSession.Instance.User;
            this.project = project;
        ...
        private void DebounceTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (currentSearchBox == CbUser)
            {
                ...
                // Fetch users
                //var users = userServices.GetUserByKw(searchText);
